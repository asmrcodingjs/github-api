...
async function handleSearch() {
    ...
    if (!username) return;//todo show notification;

    updateProfileDisplay("none")
    ...
    updateProfile(data)
    updateRepositoires(repositories)
...
function updateRepositoires(data) {
    const repositories = document.querySelector(".repositories__items")
